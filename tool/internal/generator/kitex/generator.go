...
func (g *Generator) printSuccess() {
	...
	fmt.Printf("  |-- internal/\n")
	fmt.Printf("  |   |-- config/                 # Shared config\n")
	fmt.Printf("  |   |   +-- config.go\n")
	fmt.Printf("  |   |-- rpc/\n")
	fmt.Printf("  |   |   |-- server/\n")
	fmt.Printf("  |   |   |   +-- %s_server.go\n", g.serviceLower)
	fmt.Printf("  |   |   +-- logic/\n")
	fmt.Printf("  |   |       +-- *_logic.go      # Logic files per RPC\n")
	fmt.Printf("  |   +-- svc/                    # Shared service context\n")
	fmt.Printf("  |       +-- service_context.go\n")
	fmt.Printf("  |-- kitex_gen/                  # Generated by kitex\n")
	fmt.Printf("  |-- etc/\n")
	fmt.Printf("  |   +-- rpc.yaml                # RPC configuration\n")
	fmt.Printf("  +-- go.mod\n")
	fmt.Println()
	fmt.Println("Next steps:")
	fmt.Printf("  1. cd %s\n", g.opts.OutputDir)
	fmt.Println("  2. go mod tidy")
	fmt.Println("  3. Implement business logic in internal/rpc/logic/*_logic.go files")
	fmt.Println("  4. go run cmd/rpc/main.go")
	fmt.Println()
