...
// Generator generates GORM models and repositories from database schema
...
// Generate generates GORM models and repositories
...
// generateModels generates GORM model files
...
// generateRepositories generates GORM repository files
